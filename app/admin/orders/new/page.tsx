        ...
        <div className="lg:col-span-1">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Services included with this order type
              </CardDescription>
            </CardHeader>
            <CardContent>
              {!selectedOrderType ? (
                <p className="text-sm text-muted-foreground">
                  Select an order type to view included services
                </p>
              ) : selectedOrderType.services.length === 0 ? (
                <p className="text-sm text-muted-foreground">
                  No services associated with this order type
                </p>
              ) : (
                <div className="space-y-3">
                  <div className="text-sm font-medium">
                    {selectedOrderType.services.length} service
                    {selectedOrderType.services.length !== 1 ? 's' : ''} will be added
                  </div>
                  <div className="space-y-2">
                    {selectedOrderType.services.map((service) => (
                      <div
                        key={service.id}
                      ...
                      >
                        ...
                        <div className="text-xs text-muted-foreground space-y-1">
                          {service.team && (
                            <div>Team: {service.team.name}</div>
                          )}
                          {service.timeLimit && (
